      ...
      <div class="row">
        ...
        <div class="box">
          ...
          <img src="{{ URL::asset("images/{$data->ImageURL}") }}" width="150px" class="img-fluid">
            ...
            <a href="{{ url('ewindo-data/index_all/') }}" class="btn btn-default">Kembali ke list data</a>
            <br><br>
            ...
            @foreach($data2 as $row => $value)
                ...
                <td>{{ $no }}</td>
                    ...
                    <td>
                        <a href="{{ url('ewindo-data/crop/edit_all', $value->imageID) }}" class="btn btn-success btn-md" title="Ubah Data ini"><i class="fa fa-plus"></i> Perbaharui</a>
                    </td>
                    <td>
                        <a href="{{ url('ewindo-data/crop/detail_all', $value->imageID) }}" class="btn btn-default btn-md" title="Lihat Data ini"><i class="fa fa-eye"></i> Lihat</a>
                    </td>
                    <td>
                        <a href="{{ url('ewindo-data/crop/hapus_all', $value->imageID) }}" class="btn btn-danger btn-md" title="Hapus Data ini"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
