  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <a class="close" aria-label="Close" href="{{ url('ewindo-data/index_all/') }}">
      ...
      <div class="modal-footer">
        <a class="btn btn-secondary" href="{{ url('ewindo-data/index_all/') }}">Cancel</a>
        ...
        var reader = new FileReader();
         ...
         reader.onloadend = function() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('ewindo-data/upload_all',$data->imageID) }}",
                data: {'_token': $('meta[name="_token"]').attr('content'), 'image': base64data},
                success: function(data){
                    $modal.modal('hide');
                    alert("success upload image");
                    window.location.href = "{{ url('ewindo-data/index_all/') }}";
                }
              });
         }
    });
