      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Data Tanaman Milik [ {{ $data3->name }} - {{ $data3->role }} ]</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{ url('admin-data/update_all',$data['imageID']) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="box-body">
              <div class="form-group">
                ...
                <label for="inputPassword3" class="col-sm-2 control-label"></label>
                  <div class="col-sm-10">
                  <a href="{{ url('admin-data/index_all/') }}" class="btn btn-default btn-flat"><i class="fa fa-close"></i> Batal</a>
