    ...
    <section class="content">   
      ...
      <div class="row">
        ...
        <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{ url('balitsa-data/update_all',$data['imageID']) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="box-body">
              <div class="form-group">
                ...
                <label for="inputPassword3" class="col-sm-2 control-label"></label>
                  <div class="col-sm-10">
                  <a href="{{ url('balitsa-data/index_all/') }}" class="btn btn-default"><i class="fa fa-close"></i> Batal</a>
