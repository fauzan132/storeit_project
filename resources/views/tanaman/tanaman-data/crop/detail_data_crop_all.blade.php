            ...
            {{ csrf_field() }}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="{{ URL::asset("upload/{$data['ImageURL']}") }}" data-toggle="lightbox" data-gallery="image-gallery" data-title="{{ $data['plantType'] }}" style="width:500px">
                    <img src="{{ URL::asset("upload/{$data['ImageURL']}") }}" class="img-fluid" width="600px">
                    </a>
                ...
                <label for="inputPassword3" class="col-sm-2 control-label"></label>
                  <div class="col-sm-10">
                  <a href="{{ url('tanaman-data/crop/awal_all', $data['imageID_raw']) }}" class="btn btn-primary"><i class="fa fa-save"></i> Kembali</a>
                  </div>
                </div>
              </div>
