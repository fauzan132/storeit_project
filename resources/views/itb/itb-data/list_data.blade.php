      ...
      <div class="row">
        ...
        <div class="box">
          ...
          <img src="{{ URL::asset("images/{$value->ImageURL}") }}" width="150px" class="img-fluid">
                    ...
                    <td>
                        <a href="{{ url('itb-data/crop/awal', $value->imageID) }}" class="btn btn-info btn-md" title="Lihat Data ini"><i class="fa fa-eye"></i> Lihat Crop</a>
                    </td>
                    <td>
                        <a href="{{ url('itb-data/cropping', $value->imageID) }}" class="btn btn-success btn-md" title="Crop Data ini"><i class="fa fa-crop"></i> Crop</a>
                    </td>
                    <td>
                        <a href="{{ url('itb-data/detail', $value->imageID) }}" class="btn btn-default btn-md" title="Lihat Data ini"><i class="fa fa-eye"></i> Lihat</a>
                    </td>
                    <td>
                        <a href="{{ url('itb-data/edit', $value->imageID) }}" class="btn btn-warning btn-md" title="Ubah Data ini"><i class="fa fa-edit"></i> Ubah</a>
                    </td>
                    <td>
