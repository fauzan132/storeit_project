  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <a class="close" aria-label="Close" href="{{ url('balitsa-data/index/') }}">
      ...
      <div class="modal-footer">
        <a class="btn btn-secondary" href="{{ url('balitsa-data/index/') }}">Cancel</a>
        ...
        var reader = new FileReader();
         ...
         reader.onloadend = function() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('balitsa-data/upload',$data->imageID) }}",
                data: {'_token': $('meta[name="_token"]').attr('content'), 'image': base64data},
                success: function(data){
                    $modal.modal('hide');
                    alert("success upload image");
                    window.location.href = "{{ url('balitsa-data/index/') }}";
                }
              });
         }
    });
