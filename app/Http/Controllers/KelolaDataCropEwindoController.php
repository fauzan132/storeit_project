...
class KelolaDataCropEwindoController extends Controller
{
    /**
    ...
    public function awal($id)
    {
        ...
        return view('ewindo.ewindo-data.crop.list_data_crop')
        ->with('data', $data)
        ->with('data2', $data2);
    }
    ...
    public function awal_all($id)
    {
        $data = KelolaData::getListDataHeader($id);
        $data2 = KelolaDataCrop::getListDataAll($id);
        return view('ewindo.ewindo-data.crop.list_data_crop_all')
        ->with('data', $data)
        ->with('data2', $data2);
    }
    ...
    public function show($id)
    {
        ...
        return view('ewindo.ewindo-data.crop.detail_data_crop')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function show_all($id)
    {
        ...
        $data2 = KelolaDataCrop::getListDataAllInForm($id);
        $data3 = KelolaDataCrop::getListDataAllInForm2($id);
        return view('ewindo.ewindo-data.crop.detail_data_crop_all')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function edit($id)
    {
        ...
        $data2 = KelolaDataCrop::getListDataAllInForm($id);
        $data3 = KelolaDataCrop::getListDataAllInForm2($id);
        return view('ewindo.ewindo-data.crop.formubah_data_crop')
        ->with('data', $data)
        ->with('data3', $data3)
        ->with('data2', $data2);
    }
    ...
    public function edit_all($id)
    {
        ...
        $data2 = KelolaDataCrop::getListDataAllInForm($id);
        $data3 = KelolaDataCrop::getListDataAllInForm2($id);
        return view('ewindo.ewindo-data.crop.formubah_data_crop_all')
        ->with('data', $data)
        ->with('data3', $data3)
        ->with('data2', $data2);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->save();
        return redirect('ewindo-data/crop/awal/'. $imageid_raw);
    }
    ...
    public function update_all(Request $request, $id)
    {
        ...
        $data->save();
        return redirect('ewindo-data/crop/awal_all/'. $imageid_raw);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('ewindo-data/crop/awal/'. $image_raw);
    }
    ...
    public function destroy_all($id)
    {
        $image_raw = KelolaDataCrop::select('imageID_raw')->where('imageID', $id)->value('imageID_raw');
        KelolaDataCrop::find($id)->delete();
        return redirect('ewindo-data/crop/awal_all/'. $image_raw);
    }
}
