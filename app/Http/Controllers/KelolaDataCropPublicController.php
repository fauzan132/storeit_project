...
class KelolaDataCropPublicController extends Controller
{
    /**
    ...
    public function awal($id)
    {
        ...
        //print_r($data2);
        return view('public.public-data.crop.list_data_crop')
        ->with('data', $data)
        ->with('data2', $data2);
    }
    ...
    public function edit($id)
    {
        ...
        return view('public.public-data.crop.formubah_data_crop')
        ->with('data', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->save();
        return redirect('public-data/crop/awal/'. $imageid_raw);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('public-data/crop/awal/'. $image_raw);
    }
}
