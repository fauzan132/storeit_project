...
class KelolaDataITBController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('expert_itb.itb-data.list_data')
        ->with('data', $data);
    }
    ...
    public function index_all()
    {
        ...
        return view('expert_itb.itb-data.list_data_all')
        ->with('data', $data);
    }
    ...
    {
        return view('expert_itb.itb-data.form_data');
    }
    ...
    public function show($id)
    {
        ...
        return view('expert_itb.itb-data.detail_data')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function edit($id)
    {
        $data = KelolaData::find($id);
        $data2 = KelolaData::getListDataAllInUpdate($id);
        return view('expert_itb.itb-data.formubah_data')
        ->with('data', $data)
        ->with('data2', $data2);
    }
    ...
    public function edit_all($id)
    {
        ...
        $data2 = KelolaData::getListDataAllInUpdate($id);
        $data3 = KelolaData::getListDataAllInUpdate2($id);
        return view('expert_itb.itb-data.formubah_data_all')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function cropping($id)
    {
        ...
        return view('expert_itb.itb-data.cropper')
        ->with('data', $data);
    }
