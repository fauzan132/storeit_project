...
class KelolaDataITBController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('itb.itb-data.list_data')
        ->with('data', $data);
    }
    ...
    public function index_all()
    {
        ...
        return view('itb.itb-data.list_data_all')
        ->with('data', $data);
    }
    ...
    {
        return view('itb.itb-data.form_data');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return redirect('itb-data/index');
    }
    ...
    public function show($id)
    {
        ...
        return view('itb.itb-data.detail_data')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function show_all($id)
    {
        ...
        $data2 = KelolaData::getListDataAllInUpdate($id);
        $data3 = KelolaData::getListDataAllInUpdate2($id);
        return view('itb.itb-data.detail_data_all')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function edit($id)
    {
        $data = KelolaData::find($id);
        $data2 = KelolaData::getListDataAllInUpdate($id);
        return view('itb.itb-data.formubah_data')
        ->with('data', $data)
        ->with('data2', $data2);
    }
    ...
    public function edit_all($id)
    {
        ...
        $data2 = KelolaData::getListDataAllInUpdate($id);
        $data3 = KelolaData::getListDataAllInUpdate2($id);
        return view('itb.itb-data.formubah_data_all')
        ->with('data', $data)
        ->with('data2', $data2)
        ->with('data3', $data3);
    }
    ...
    public function update_all(Request $request, $id)
    {
        ...
        $data->save();
        return redirect('itb-data/index_all');
    }
    ...
    public function cropping($id)
    {
        ...
        return view('itb.itb-data.cropper')
        ->with('data', $data);
    }
    public function cropping_all($id)
    {
        $data = KelolaData::find($id);
        //print_r($data->imageID);
        return view('itb.itb-data.cropper_all')
        ->with('data', $data);
    }
